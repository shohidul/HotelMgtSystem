...
public class BookingStatus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(31, 31, 31)
                .addComponent(jLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void searchjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchjButtonActionPerformed
        // TODO add your handling code here:
        try {
            ps = con.prepareStatement("Select BookingNo, CCode, Name, RoomNo, DateOfArival, DateOfDeparture, BookingForDays, CheckedStatus  from booking where BookingNo=? ");
    ...
    private void showBookingTable() {
        try {
            ps = con.prepareStatement("Select BookingNo, CCode, Name, RoomNo, DateOfArival, DateOfDeparture, BookingForDays, CheckedStatus  from booking ");
            rs = ps.executeQuery();
            jTable.setAutoResizeMode(jTable.AUTO_RESIZE_ALL_COLUMNS);
            jTable.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
